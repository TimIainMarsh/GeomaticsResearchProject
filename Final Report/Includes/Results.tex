...
float CurvatureThreshold = 1.0;
	...
	\section{Model Generation}
		...
		\subsection{Deciding Which Points to Adjust}
			There are 4 points essentially defining each segment, it is these 4 points that are adjusted so that the segment representing a wall actually defines a wall. To do this we project the two closest points onto the line.
	
%project = dist to line --> project to line
