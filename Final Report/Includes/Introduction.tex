...
\chapter{Introduction}
	...
	\section{Objectives}
		...
		The primary objective of this project is to be able to create boundary representation models from indoor laser scans. This will be achieved by answering a few simple questions:
