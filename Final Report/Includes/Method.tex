...
\chapter{Method}%TODO Check Caps and sense
...
\section{Downsampling point clouds}
	...
	\begin{figure}[H]
		...
		\caption{A Point Cloud After Voxel Downsampling to a 1cm Resolution}
